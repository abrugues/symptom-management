package org.coursera.capstone.server.auth;
	...
	protected static class OAuthConfig extends
		...
		public OAuthConfig() throws Exception {
			...
			ClientDetailsService csvc = new InMemoryClientDetailsServiceBuilder()
							...
							.scopes("read","write").resourceIds("doctor")
							.and()
			...
			UserDetailsService svc = new InMemoryUserDetailsManager(
					Arrays.asList(
									User.create("jwatson", "pass", "DOCTOR"),
									User.create("ghouse", "pass", "DOCTOR"),
									User.create("jodoe", "pass", "PATIENT"),
									User.create("jadoe", "pass", "PATIENT"),
									User.create("sseguin", "pass", "PATIENT")));
